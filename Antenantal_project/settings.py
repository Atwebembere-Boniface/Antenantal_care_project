...
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    "django-insecure-nb+y6%4o7gs&ont+37@r_$c@arjye@qivt5i(+$l(jpf5&hx(m)"
)
...
ROOT_URLCONF = 'Antenantal_project.urls'
...
WSGI_APPLICATION = 'Antenantal_project.wsgi.application'
...
REMINDER_INTERVAL_SECONDS = int(os.environ.get("REMINDER_INTERVAL_SECONDS", 10))